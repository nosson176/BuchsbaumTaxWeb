    ...
    <section aria-labelledby="user-information-title">
      <div class="bg-white">
        <div class="px-4 py-5 bg-gray-50 sm:px-6">
          <h2 id="user-information-title" class="text-lg leading-6 font-medium text-gray-900" contenteditable>
            {{ username }}
          </h2>
        </div>
          ...
          <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
            <div class="sm:col-span-1">
              ...
              <dd class="mt-1 text-sm text-gray-900">
                <input v-model="firstName" @blur="onBlur" />
              </dd>
            </div>
            <div class="sm:col-span-1">
              <dt class="text-sm font-medium text-gray-500">Last Name</dt>
              <dd class="mt-1 text-sm text-gray-900">
                <input v-model="lastName" @blur="onBlur" />
              </dd>
            </div>
          </dl>
          <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
            <div class="sm:col-span-1" @click="toggleEditable('type')">
              <label class="text-sm font-medium text-gray-500">Privelage Set</label>
            ...
            <div class="sm:col-span-1">
              ...
              <dd class="mt-1 text-sm text-gray-900" @click="toggleEditable('secondsInDay')">
                <EditableInput v-model="secondsInDay" :is-editable="isEditable('secondsInDay')" @blur="onBlur" />
              </dd>
            </div>
          </dl>
          <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
