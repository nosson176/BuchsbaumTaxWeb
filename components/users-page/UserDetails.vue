        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
          <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
            <div class="sm:col-span-1">
              ...
              <dd class="mt-1 text-sm text-gray-900" @click="toggleEditable('type')">
                <EditableInput v-model="firstName" :is-editable="isFirstNameEditable" @blur="onBlur" />
              </dd>
            </div>
            <div class="sm:col-span-1">
          ...
          <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
            <div class="sm:col-span-1">
              ...
              <dd class="mt-1 text-sm text-gray-900" @click="toggleEditable('type')">
                <EditableSelectCell v-model="userType" :is-editable="isTypeEditable" :options="[]" @blur="onBlur" />
              </dd>
            </div>
            <div class="sm:col-span-1">
              <dt class="text-sm font-medium text-gray-500">Seconds in Day</dt>
              <dd class="mt-1 text-sm text-gray-900">
                <EditableInput v-model="secondsInDay" :is-editable="isSecondsInDayEditable" @blur="onBlur" />
              </dd>
            </div>
          </dl>
          <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
