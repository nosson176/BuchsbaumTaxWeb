                ...
                <transition-group type="transition" :name="transitionName">
                    <TableRow v-for="(type, idx) in incFbarCurrencies" :key="type.id" class="pr-1 cursor-pointer"
                        ...
                        <div class="table-col w-full">
                            <EditableInput v-model="type.value" @click="toggleEditable(type.id)"
...
const TABLE_TYPE = 'tax_type'

export default {
    name: 'IncFbarTaxTypeTable',
    ...
    methods: {
        ...
        handleUpdate() {
            const value = Object.values(this.incFbarCurrencies).find((type) => type.id === this.editableId)
        ...
        onDrop(evt) {
            ...
            const list = Object.values({ ...this.incFbarCurrencies });
        ...
        resetOrder() {
            ...
            const list = [...this.incFbarCurrencies];
            ...
            const item = this.incFbarCurrencies[0];
            item.sortOrder = 0;
