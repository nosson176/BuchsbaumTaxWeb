<template>
  <div>
    ...
    <div class="mt-1 relative">
      ...
      <div v-else-if="currency" class="mx-1 font-bold cursor-pointer" @click.stop="toggleShowOptions">
        {{ selectedCurrency }}
      </div>
      <div v-else>
        <input ref="filter" v-model="computedValue" type="text"
          ...
          :class="sizeClassObj" :placeholder="shownValue" @keyup="onInputKeyup($event.key)" @click="onInputClick"
          @focusin="toggleShowOptions" @focusout="toggleShowOptions" />
    ...
    <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100"
      ...
      <ul v-if="showOptions"
        ...
        tabindex="-1" :class="[dropdownHeight, sizeClassObj]" role="listbox" aria-labelledby="listbox-label"
